      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div className="space-y-4 rounded-xl border border-slate-100 bg-white p-5 shadow-sm">
          ...
          <div className="border-t border-slate-50 pt-3 space-y-4">
            <div className="space-y-1">
              <label className="text-xs font-medium text-slate-700">Опікун (пресвітер / опіка відповідальний)</label>
              <input
                type="text"
                name="presviter"
                value={formData.presviter || ''}
                onChange={handleChange}
                placeholder="напр., пресвітер Черняк"
                className="w-full rounded-lg border border-slate-200 p-2.5 text-sm focus:border-blue-500 focus:outline-none"
              />
        ...
        <div className="space-y-4 rounded-xl border border-slate-100 bg-white p-5 shadow-sm">
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <option value="Постійно відвідує">Постійно відвідує</option>
              <option value="Пропускає часто">Пропускає часто</option>
              <option value="Тимчасово відсутній">Тимчасово відсутній</option>
              <option value="Хворий / Вдома">Хворий / Вдома</option>
              <option value="Присутній періодично">Присутній періодично</option>
            </select>
          </div>
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <option value="У місті (не виїжджав)">У місті (не виїжджав)</option>
              <option value="Виїхав за кордон">Виїхав за кордон (Тимчасово)</option>
              <option value="Переселенець (ВПО)">Переселенець (ВПО)</option>
              <option value="В іншій області">В іншій області</option>
            </select>
          </div>
